...
#### 问题2：第二大命令git没有……
解决：这次学乖了，先去搜了一下git是什么，找到一个 [git安装包](https://git-scm.com/download/win) ，装上试试。有一个叫做Git GUI的东西，可以clone，设置非常容易。然后还有一个叫做Git Bash的，打开像是个terminal，这里可以用`git pull origin master`
####
